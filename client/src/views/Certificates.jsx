...
const certificates = [
  ...
  },
  {
    ...
    credentials: [
      {
        issuer: "Developer Student Clubs by Google",
        image: u(GoogleCloudcomputing),
        link: "https://www.cert.devtown.in/verify/13NJJz",
      },
      {
        issuer: "Microsoft Learn Student Ambassador",
        image: u(MicrosoftCloudComputing),
  ...
  },
  {
    ...
    credentials: [
      {
        issuer: "Developer Student Clubs by Google",
        image: u(GoogleJavaScriptReact),
        link: "https://www.cert.devtown.in/verify/1UuGJB",
      },
      {
        issuer: "Microsoft Learn Student Ambassador",
        image: u(MicrosoftJavaScriptReact),
  ...
  },
  {
    ...
    credentials: [
      {
        issuer: "Developer Student Clubs by Google",
        image: u(GooglePythonOpenCV),
        link: "https://www.cert.devtown.in/verify/ZrusJA",
      },
      {
        issuer: "Microsoft Learn Student Ambassador",
        image: u(MicrosoftPythonOpenCV),
  ...
  },
  {
    ...
    credentials: [
      {
        issuer: "Developer Student Clubs by Google",
        image: u(GoogleTinderClone),
        link: "https://www.cert.devtown.in/verify/24zuvz",
      },
      {
        issuer: "Microsoft Learn Student Ambassador",
        image: u(MicrosoftTinderClone),
